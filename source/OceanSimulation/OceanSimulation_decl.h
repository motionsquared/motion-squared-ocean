...
namespace OceanSimulation {
	...
	{
		MAXON_INTERFACE(OceanInterface, MAXON_REFERENCE_NORMAL, "net.motionsquared.ocean.interfaces.ocean", MAXON_IMPLEMENTATION_MODULE("net.motionsquared.ocean"));
...
#include "OceanSimulation_decl1.hxx"
	...
	MAXON_DECLARATION(maxon::Class<OceanRef>, Ocean, "net.motionsquared.ocean.simulation", MAXON_IMPLEMENTATION_MODULE("net.motionsquared.ocean"));
